...
public static class ArrayExtension
{
    ...
    public static T RandomObject<T>(this IList<T> list) => RandomObject(list, Random.Range);
    ...
    public static void Shuffle<T>(this IList<T> list) => Shuffle(list, Random.Range);
