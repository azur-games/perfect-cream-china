...
{
    internal class AmazonBuildPostprocessorContext : AndroidBuildPostprocessorContext, IAmazonBuildPostprocessorContext
    {
        public AmazonBuildPostprocessorContext(
