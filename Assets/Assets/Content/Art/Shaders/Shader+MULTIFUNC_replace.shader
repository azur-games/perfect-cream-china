Shader "Playgendary/Shader+MULTIFUNC_replace"
{
    Properties
    {
        _3TColor1 ("Color 1", Color) = (1,1,1,1)
        _3TColor2 ("Color 2", Color) = (1,1,1,1)
        _3TColor3 ("Color 3", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(vertexOutput i) : SV_Target
            {
                ...
                resultColor  = lerp(tex2D(_MainTex, i.uv), tex2D(_SecondMainTex, i.uv), _TransitionFactor);
                #else
                resultColor = tex2D(_MainTex, i.uv);
                #endif

                resultColor = _3TColor1 * resultColor.r + _3TColor2 * resultColor.g + _3TColor3 * resultColor.b;
