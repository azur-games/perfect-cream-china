Shader "Playgendary/Shader+MULTIFUNC_gradient"
{
    Properties
    {
        _2TColor1 ("Color 1", Color) = (1,1,1,1)
        _2TColor2 ("Color 2", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(vertexOutput i) : SV_Target
            {
                ...
                resultColor = lerp(_2TColor1, _2TColor2, resultColor.r);
